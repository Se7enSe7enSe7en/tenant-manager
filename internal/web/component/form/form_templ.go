...
import (
	...
	"github.com/Se7enSe7enSe7en/tenant-manager/internal/web/component/label"
	"strings"
)
...
func FormItem(args FormItemArgs) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/form/form.templ`, Line: 1, Col: 0}
		}
...
func FormDescription(args FormDescriptionArgs) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if args.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/form/form.templ`, Line: 135, Col: 15}
			}
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if args.Message != "" {
			...
			if args.ID != "" {
				...
				templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.ResolveAttributeValue(args.ID)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/form/form.templ`, Line: 151, Col: 16}
				}
			...
			if args.Message != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/form/form.templ`, Line: 157, Col: 18}
				}
