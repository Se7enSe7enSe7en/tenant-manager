...
import (
	...
	"github.com/Se7enSe7enSe7en/tenant-manager/internal/web/component/icon"
)
...
func Input(props ...Props) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/input/input.templ`, Line: 60, Col: 12}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/input/input.templ`, Line: 61, Col: 24}
		}
		...
		if p.Name != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/input/input.templ`, Line: 63, Col: 17}
			}
		...
		if p.Placeholder != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/input/input.templ`, Line: 66, Col: 31}
			}
		...
		if p.Value != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/input/input.templ`, Line: 69, Col: 19}
			}
		...
		if p.Type == TypeFile && p.FileAccept != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/input/input.templ`, Line: 72, Col: 25}
			}
		...
		if p.Form != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/input/input.templ`, Line: 75, Col: 17}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/input/input.templ`, Line: 1, Col: 0}
		}
